...
class TeamController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('@Survey/admin/team/index.html.twig', array(
            'teams' => $teams,
        ));
    }
    ...
    {
        $team = new Team();
        $form = $this->createForm('SurveyBundle\Form\TeamType', $team);
        ...
        return $this->render('@Survey/admin/team/new.html.twig', array(
            'team' => $team,
    ...
    public function showAction(Team $team)
    {
        ...
        return $this->render('@Survey/admin/team/show.html.twig', array(
            'team' => $team,
    ...
    {
        $deleteForm = $this->createDeleteForm($team);
        $editForm = $this->createForm('SurveyBundle\Form\TeamType', $team);
        ...
        return $this->render('@Survey/admin/team/edit.html.twig', array(
            'team' => $team,
